...
public class C0555i {
    /* renamed from: a */
    public static File m2446a(Context context) {
    ...
    private static java.nio.ByteBuffer m2449a(java.io.File r9) {
        /*
            r0 = 0
        ...
        L_0x0032:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p026v4.graphics.C0555i.m2449a(java.io.File):java.nio.ByteBuffer");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.nio.ByteBuffer m2448a(android.content.Context r8, android.os.CancellationSignal r9, android.net.Uri r10) {
        /*
        ...
        L_0x0067:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p026v4.graphics.C0555i.m2448a(android.content.Context, android.os.CancellationSignal, android.net.Uri):java.nio.ByteBuffer");
    }

    /* renamed from: a */
    public static ByteBuffer m2447a(Context context, Resources resources, int i) {
        File a = m2446a(context);
        if (a == null) {
            return null;
        }
        try {
            if (!m2451a(a, resources, i)) {
                return null;
            }
            ByteBuffer a2 = m2449a(a);
            a.delete();
            return a2;
        } finally {
            a.delete();
    ...
    /* renamed from: a */
    public static boolean m2452a(File file, InputStream inputStream) {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (read != -1) {
                        ...
                        m2450a((Closeable) fileOutputStream2);
                ...
                try {
                    ...
                    m2450a((Closeable) fileOutputStream);
                    StrictMode.setThreadPolicy(allowThreadDiskWrites);
                    return false;
                } catch (Throwable th) {
                    th = th;
    ...
    /* renamed from: a */
    public static boolean m2451a(File file, Resources resources, int i) {
        InputStream inputStream;
        try {
            inputStream = resources.openRawResource(i);
            try {
                boolean a = m2452a(file, inputStream);
                m2450a((Closeable) inputStream);
                return a;
            } catch (Throwable th) {
                th = th;
                m2450a((Closeable) inputStream);
    ...
    /* renamed from: a */
    public static void m2450a(Closeable closeable) {
        if (closeable != null) {
            try {
                closeable.close();
            } catch (IOException unused) {
