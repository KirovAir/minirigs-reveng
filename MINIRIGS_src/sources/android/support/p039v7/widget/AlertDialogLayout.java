...
public class AlertDialogLayout extends C0886as {
    ...
    /* renamed from: c */
    private boolean m3699c(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0639a.C0645f.topPanel) {
                    view = childAt;
                } else if (id == C0639a.C0645f.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C0639a.C0645f.contentPanel && id != C0639a.C0645f.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
        ...
        m3700d(childCount, i9);
        return true;
    }

    /* renamed from: d */
    private void m3700d(int i, int i2) {
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824);
        for (int i3 = 0; i3 < i; i3++) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() != 8) {
                C0886as.C0887a aVar = (C0886as.C0887a) childAt.getLayoutParams();
                if (aVar.width == -1) {
                    int i4 = aVar.height;
    ...
    /* renamed from: c */
    private static int m3698c(View view) {
        int j = C0594r.m2609j(view);
        if (j > 0) {
            return j;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m3698c(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if (!(childAt == null || childAt.getVisibility() == 8)) {
                ...
                m3697a(childAt, i7, i13, measuredWidth, measuredHeight2);
    ...
    /* renamed from: a */
    private void m3697a(View view, int i, int i2, int i3, int i4) {
