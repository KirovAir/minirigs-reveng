...
public class C0120d {
    /* renamed from: a */
    public static Interpolator m344a(Context context, int i) {
        ...
        if (i == 17563663) {
            ...
            Interpolator a = m345a(context, context.getResources(), context.getTheme(), animation);
            if (animation != null) {
                animation.close();
            }
            return a;
    ...
    /* renamed from: a */
    private static Interpolator m345a(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser) {
            ...
            if ((next != 3 || xmlPullParser.getDepth() > depth) && next != 1) {
                if (next == 2) {
                    ...
                    if (name.equals("linearInterpolator")) {
                        ...
                        interpolator = new C0124g(context, asAttributeSet, xmlPullParser);
                    } else {
